...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      ...
      adapter: 'sails-mongo',
      url: 'mongodb://admin:123@127.0.0.1/vasystem'
  ...
  http: {
     ...
     *                                                                          *
     ***************************************************************************/
    cache: 60 * 24 * 60 * 60 * 1000, // 60 days
  ...
  custom: {
    ...
    mailerConfig: {
      transporter: {
        ...
        secure: false,
        auth: {
          // user: 'aifp.stock@gmail.com',
          user: 'info',
          pass: 'QrmNzaweBemzwK3D',
        },
        tls: {
    ...
    stockPredictUrl: 'http://localhost:10818'
  },
};
